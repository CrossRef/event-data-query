...
(deftest event->document
  (testing "DOI fields should be associated with the Event when present."
    (let [event {:obj_id "http://dx.doi.org/10.5555/12345678" ; old-style DOI supplied
                 ...
                 :evidence_record "https://evidence.eventdata.crossref.org/evidence/20170404-twitter-66e922df-9754-45f7-886f-f7ddaa6ea8ba"
      ...
      (is (= (:obj-id document) "http://dx.doi.org/10.5555/12345678") "Even though obj_id uses a dx.doi.org resolver, it's unchanged.")
